...
export class InvoiceComponent implements OnInit {
  ...
  excutePayment()
  {
    this.paymentService.excutePayment(this.paymentId,this.token,this.payerId,this.user.id).subscribe(
      res =>{
         this.invoiceService.createInvoice(this.user.id,this.user.email,this.date,this.invoice.transaction.payee.email,
           this.paymentId,this.invoice.transaction.amount.total).subscribe(
             res=>{
  ...
  getReviewPayment()
  {
    this.paymentService.getReviewPayment(this.paymentId).subscribe(
        res=>{
          this.invoice=res
          console.log("invoice: ")
